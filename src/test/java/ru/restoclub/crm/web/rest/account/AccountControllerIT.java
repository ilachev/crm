package ru.restoclub.crm.web.rest.account;
...
import ru.restoclub.crm.repository.user.AuthorityRepository;
import ru.restoclub.crm.repository.user.UserRepository;
import ru.restoclub.crm.security.AuthoritiesConstants;
import ru.restoclub.crm.service.MailService;
import ru.restoclub.crm.service.account.dto.PasswordChangeDTO;
import ru.restoclub.crm.service.user.UserService;
import ru.restoclub.crm.service.user.dto.UserDTO;
import ru.restoclub.crm.web.rest.TestUtil;
import ru.restoclub.crm.web.rest.error.ExceptionTranslator;
import ru.restoclub.crm.web.rest.user.vm.KeyAndPasswordVM;
import ru.restoclub.crm.web.rest.user.vm.ManagedUserVM;
...
public class AccountControllerIT {
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        IterableAssert<Authority> authorityIterableAssert = assertThat(userDup.get().getAuthorities()).hasSize(1)
    ...
    public void testActivateAccount() throws Exception {
        ...
        assertThat(Objects.requireNonNull(user).getActivated()).isTrue();
    }
